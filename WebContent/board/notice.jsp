...
<div class="boardBack">
	<div class="boardTop">
	<br>
	<font style="font-size: 40px; font-weight: bold; color: gray">공지사항</font>
	<br><br>
	...
	<div class="boardTable">
		<div class="boardLeft">
			<ul>
  			<li><a href="/web/board/notice.jsp">공지사항<span class="glyphicon glyphicon-menu-right" style="margin-left: 18px;"></span></a></li>
 			<li><a href="/web/board/qna.jsp">Q&A<span class="glyphicon glyphicon-menu-right" style="margin-left: 44px;"></span></a></li>
			<li><a href="/web/board/faq.jsp">FAQ<span class="glyphicon glyphicon-menu-right" style="margin-left: 47px;"></span></a></li>
			<li><a href="/web/boardList.do?cmd=boardList&job=notice">자유게시판<span class="glyphicon glyphicon-menu-right"></span></a></li>
			</ul>
		...
		<table class="table" cellpadding="0" cellspacing="0" >
			...
			<c:forEach items="${boardList }" var="i" varStatus="cnt">
			<tr>
			<td height="30px">${cnt.count }</td>
			<td class="title"><a href="/web/boardHit.do?cmd=boardHit&job=notice&pk=${i.oboard_no }&page=${param.page}">${i.oboard_title }</a><img src="/web/image/icon_hot.gif"/></td>
			<td><img src="/web/image/logo.png" width="20px" height="20px"/></td>
			<td>${i.oboard_regdate }</td>
			<td>${i.oboard_hit }</td>
			</tr>
			</c:forEach>
		</table>
		<div class="wirte">
		<a href="/web/board/write.jsp?job=notice"><img src="/web/image/btn_write.gif"/></a>
		</div>
		<div class="paging">
			...
			<span>
				...
				<c:when test="${pageBean.currentPage eq i }">
					<font color=aqua; size="3px" style="font-weight: bold;">[${i }]</font>
				</c:when>
				<c:otherwise>
					<a href="boardList.do?cmd=boardList&job=notice&page=${i }">[${i }]</a>
				</c:otherwise>
				</c:choose>
				</c:forEach>
			</span>
