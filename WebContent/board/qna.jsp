...
<div class="boardBack">
	<div class="boardTop">
	<br>
	<font style="font-size: 40px; font-weight: bold; color: gray">Q&A</font>
	<br><br>
	...
	<div class="boardTable">
		...
		<table class="table" cellpadding="0" cellspacing="0" >
			...
			<tr>
			<td height="30px">1</td>
			<td class="title"><a href="info.jsp">질문</a><font style="color:red;">(1)</font><img src="/web/image/icon_secret.gif"/></td>
			...
			<tr>
			<td height="30px">1</td>
			<td class="title">질문<font style="color:red;">(1)</font><img src="/web/image/icon_secret.gif"/></td>
			<td><img src="/web/image/logo.png" width="20px" height="20px"/></td>
			<td>05-08</td>
			<td>185</td>
			</tr>
