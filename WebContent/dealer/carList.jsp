...
<body>
	...
	<div class="boardBack">
		<div class="boardTop">
			<br> <font
				style="font-size: 40px; font-weight: bold; color: gray">판매차량관리</font>
			<br>
			<br> <font style="font-size: 12px; color: silver;">자신이 올린
				차량을 한눈에 확인해 보세요.</font>
		</div>
		<div class="boardTable">
			...
			<div class="boardRight">
				...
				<table class="table" cellpadding="0" cellspacing="0">
					<tr>
						<th width="5%" height="30px">번호</th>
						<th width="10%">중고차번호</th>
						<th width="10%">중고차 이름</th>
						<th width="10%">중고차 종류</th>
						<th width="10%">중고차 제조사</th>
						<th width="10%">중고차 가격</th>
					</tr>
					<tr>
						<td height="30px">1</td>
					...
					<tr>
						<td height="30px">2</td>
						<td class="title" style="text-align: center">33나7899</td>
						<td>아우디A4</td>
						<td>중형차</td>
						<td>아우디</td>
						<td>49,500,000</td>
