...
<body>
<div class="tt">
<p style="margin-left: 30px; font-size: 13px; font-weight: bold;"><img alt="" src="/web/image/ic.png">100자로 평가해주세요</p>
<div class = "total">
<div class="inin" >
  ...
  <output for="star-input"><b>0</b>점</output>
		...
		<div class="inin2">
			<textarea rows="4" cols="69" id="txt">100자 평가글은 1회 이상 추가 작성하실 수 있습니다.</textarea>
		</div>
		<div class="inin3">
			<input type="button" style="width: 72px; height: 68px; font-weight: bold; color: white; background-color: #6D81DF;  border: none;" value="등록">
		</div>
	</div>
	</div>
	<div style="font-size: 13px">
	<b>평가글 수</b> : 총 <font style="color: #a1373a;font-weight: bold;">0</font>개
